...
- Name: core-flows.spec.ts >> YYC³ Easy Table Converter - Core User Flows >> should navigate to CSV-JSON converter
- Location: e2e/core-flows.spec.ts:18:7
...
Call log:
  - waiting for locator('text=CSV to JSON')
