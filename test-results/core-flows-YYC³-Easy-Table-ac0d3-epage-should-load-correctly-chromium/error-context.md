...
- Name: core-flows.spec.ts >> YYC³ Easy Table Converter - Core User Flows >> homepage should load correctly
- Location: e2e/core-flows.spec.ts:8:7
...
Expected pattern: /YYC³ Easy Table Converter/
Received string:  "Grafana"
Timeout: 5000ms

Call log:
  - Expect "toHaveTitle" with timeout 5000ms
    13 × unexpected value "Grafana"
...
- main:
  ...
  - list:
    ...
    - listitem:
      ...
      - text: "|"
    - listitem:
      - link "Grafana v12.4.1 (46a02dc12a)":
